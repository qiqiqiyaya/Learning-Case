...
using (var connection = factory.CreateConnection())
{
    ...
    {
        Console.WriteLine(" direct type orange ");
        // 申明direct类型exchange
        channel.ExchangeDeclare(exchange: "directEC", type: "direct");

        channel.QueueDeclare("orange", true, false, false, null);
        // 绑定队列到direct类型exchange，需指定路由键routingKey
        channel.QueueBind(queue: "orange", exchange: "directEC", routingKey: "orange");
